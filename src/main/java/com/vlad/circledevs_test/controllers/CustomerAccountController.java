...
public class CustomerAccountController {
  ...
  @PostMapping
  public CustomerAccountDTO addAccount(@RequestBody CustomerAccountDTO customerAccount) {
    return serviceFacade.createAccount(customerAccount);
  }

  @PatchMapping
  public CustomerAccountDTO updateBank(@RequestBody CustomerAccountDTO customerAccount) {
    return serviceFacade.updateAccount(customerAccount);
  }
}
